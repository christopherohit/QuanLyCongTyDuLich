...
namespace QuanLyCongTyDuLich {
    ...
    public partial class QuanLyDuLichDataSet2 : global::System.Data.DataSet {
        ...
        public partial class AccountDataTable : global::System.Data.TypedTableBase<AccountRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AccountRow AddAccountRow(string TenTaiKhoan, string Emails) {
        ...
        public partial class AccountRow : global::System.Data.DataRow {
            ...
            public string Emails {
                get {
                    try {
                        return ((string)(this[this.tableAccount.EmailsColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Emails\' in table \'Account\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableAccount.EmailsColumn] = value;
                }
            }
            ...
            public bool IsEmailsNull() {
                return this.IsNull(this.tableAccount.EmailsColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetEmailsNull() {
                this[this.tableAccount.EmailsColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace QuanLyCongTyDuLich.QuanLyDuLichDataSet2TableAdapters {
    ...
    public partial class AccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Account] WHERE (([TenTaiKhoan] = @Original_TenTaiKhoan) AND ((" +
                "@IsNull_Emails = 1 AND [Emails] IS NULL) OR ([Emails] = @Original_Emails)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Account] ([TenTaiKhoan], [Emails]) VALUES (@TenTaiKhoan, @Emai" +
                "ls);\r\nSELECT TenTaiKhoan, Emails FROM Account WHERE (TenTaiKhoan = @TenTaiKhoan)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Account] SET [TenTaiKhoan] = @TenTaiKhoan, [Emails] = @Emails WHERE (([TenTaiKhoan] = @Original_TenTaiKhoan) AND ((@IsNull_Emails = 1 AND [Emails] IS NULL) OR ([Emails] = @Original_Emails)));
SELECT TenTaiKhoan, Emails FROM Account WHERE (TenTaiKhoan = @TenTaiKhoan)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TenTaiKhoan, Emails FROM dbo.Account";
        ...
        public virtual int Fill(QuanLyDuLichDataSet2.AccountDataTable dataTable) {
        ...
        public virtual QuanLyDuLichDataSet2.AccountDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyDuLichDataSet2.AccountDataTable dataTable = new QuanLyDuLichDataSet2.AccountDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyDuLichDataSet2.AccountDataTable dataTable) {
        ...
        public virtual int Delete(string Original_TenTaiKhoan, string Original_Emails) {
        ...
        public virtual int Insert(string TenTaiKhoan, string Emails) {
            if ((TenTaiKhoan == null)) {
        ...
        public virtual int Update(string TenTaiKhoan, string Emails, string Original_TenTaiKhoan, string Original_Emails) {
            if ((TenTaiKhoan == null)) {
                throw new global::System.ArgumentNullException("TenTaiKhoan");
            }
            else {
            ...
            if ((Original_Emails == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_Emails));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Emails, string Original_TenTaiKhoan, string Original_Emails) {
            return this.Update(Original_TenTaiKhoan, Emails, Original_TenTaiKhoan, Original_Emails);
        }
    }
